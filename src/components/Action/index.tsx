...
import { adjustLine } from "../../hooks/adjustLine";
    ...
    useEffect(()=>{
      ...
      return (
        <>
            ...
            <div id={`line-${next}`} className="line"></div>
            <div id={`line-${prev[0]}-${id}`} className="line"></div>
            <div id={`line-${prev[1]}-${id}`} className="line"></div>
        </>   
    )
}